...
CEffect_LobbyCampFireSpark* const CEffect_LobbyCampFireSpark::Create(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, CNetwork* const& pNetwork, const _tchar* const& pFilePath) {
	CEffect_LobbyCampFireSpark* pInstnace = new CEffect_LobbyCampFireSpark(pDevice, pContext, pNetwork);
	if (FAILED(pInstnace->Init_Create(pFilePath)))
		Safe_Release(pInstnace);
	return pInstnace;
}

CObject* const CEffect_LobbyCampFireSpark::Clone(void* const& pArg) {
	CEffect_LobbyCampFireSpark* pInstnace = new CEffect_LobbyCampFireSpark(*this);
	if (FAILED(pInstnace->Init_Clone(pArg)))
		Safe_Release(pInstnace);
	return pInstnace;
}

CEffect_LobbyCampFireSpark::CEffect_LobbyCampFireSpark(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, CNetwork* const& pNetwork)
	: CObject(pDevice, pContext, pNetwork) {
	XMStoreFloat4x4(&m_ViewMatrix, XMMatrixIdentity());
	XMStoreFloat4x4(&m_ProjMatrix, XMMatrixOrthographicLH((_float)g_iWinSizeX, (_float)g_iWinSizeY, 0.f, 1.f));
}

CEffect_LobbyCampFireSpark::CEffect_LobbyCampFireSpark(const CEffect_LobbyCampFireSpark& rhs)
	: CObject(rhs),
...
void CEffect_LobbyCampFireSpark::Delete(void) {
	__super::Delete();
...
const HRESULT CEffect_LobbyCampFireSpark::Init_Create(const _tchar* const& pFilePath) {
	LoadEffect(pFilePath);
	return S_OK;
}

const HRESULT CEffect_LobbyCampFireSpark::Init_Clone(void* const& pArg) {
	HRESULT hr = S_OK;
...
const _ubyte CEffect_LobbyCampFireSpark::Update(const _double& dTimeDelta) {
	if (m_bCreate) {
		if (m_bStart) {
...
void CEffect_LobbyCampFireSpark::Update_Edit(void) {
	m_pTransform->Update_Edit(0);
}

void CEffect_LobbyCampFireSpark::Late_Update(const _double& dTimeDelta) {
...
const HRESULT CEffect_LobbyCampFireSpark::Render(const CRenderer::EOrder& eOrder) {
	HRESULT hr = S_OK;
	CCamera* pCamera = CCamera::Get_Camera(static_cast<_uint>(0));
...
void CEffect_LobbyCampFireSpark::LoadEffect(const _tchar* const& pFilePath) {
...
const HRESULT CEffect_LobbyCampFireSpark::Save_Data(Json::Value& root) {
	m_pTransform->Save_Data(root["Transform"]);
	return S_OK;
}

void CEffect_LobbyCampFireSpark::Load_Data(Json::Value& root) {
	m_pTransform->Load_Data(root["Transform"]);
}

void CEffect_LobbyCampFireSpark::Update_Network(const string& pkey) {
}

void CEffect_LobbyCampFireSpark::Update_Network(void) {
}
