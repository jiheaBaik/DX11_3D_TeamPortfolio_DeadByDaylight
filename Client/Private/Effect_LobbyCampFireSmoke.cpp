...
CEffect_LobbyCampFireSmoke* const CEffect_LobbyCampFireSmoke::Create(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, CNetwork* const& pNetwork, const _tchar* const& pFilePath) {
	CEffect_LobbyCampFireSmoke* pInstnace = new CEffect_LobbyCampFireSmoke(pDevice, pContext, pNetwork);
	if (FAILED(pInstnace->Init_Create(pFilePath)))
		Safe_Release(pInstnace);
	return pInstnace;
}

CObject* const CEffect_LobbyCampFireSmoke::Clone(void* const& pArg) {
	CEffect_LobbyCampFireSmoke* pInstnace = new CEffect_LobbyCampFireSmoke(*this);
	if (FAILED(pInstnace->Init_Clone(pArg)))
		Safe_Release(pInstnace);
	return pInstnace;
}

CEffect_LobbyCampFireSmoke::CEffect_LobbyCampFireSmoke(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, CNetwork* const& pNetwork)
	: CObject(pDevice, pContext, pNetwork) {
	XMStoreFloat4x4(&m_ViewMatrix, XMMatrixIdentity());
	XMStoreFloat4x4(&m_ProjMatrix, XMMatrixOrthographicLH((_float)g_iWinSizeX, (_float)g_iWinSizeY, 0.f, 1.f));
}

CEffect_LobbyCampFireSmoke::CEffect_LobbyCampFireSmoke(const CEffect_LobbyCampFireSmoke& rhs)
	: CObject(rhs),
...
void CEffect_LobbyCampFireSmoke::Delete(void) {
	__super::Delete();
...
const HRESULT CEffect_LobbyCampFireSmoke::Init_Create(const _tchar* const& pFilePath) {
	LoadEffect(pFilePath);
	return S_OK;
}

const HRESULT CEffect_LobbyCampFireSmoke::Init_Clone(void* const& pArg) {
	HRESULT hr = S_OK;
...
const _ubyte CEffect_LobbyCampFireSmoke::Update(const _double& dTimeDelta) {
	if (m_bCreate) {
		if (m_bStart) {
...
void CEffect_LobbyCampFireSmoke::Update_Edit(void) {
	m_pTransform->Update_Edit(0);
}

void CEffect_LobbyCampFireSmoke::Late_Update(const _double& dTimeDelta) {
...
const HRESULT CEffect_LobbyCampFireSmoke::Render(const CRenderer::EOrder& eOrder) {
	HRESULT hr = S_OK;
	CCamera* pCamera = CCamera::Get_Camera(static_cast<_uint>(0));
...
void CEffect_LobbyCampFireSmoke::LoadEffect(const _tchar* const& pFilePath) {
...
const HRESULT CEffect_LobbyCampFireSmoke::Save_Data(Json::Value& root) {
	m_pTransform->Save_Data(root["Transform"]);
	return S_OK;
}

void CEffect_LobbyCampFireSmoke::Load_Data(Json::Value& root) {
	m_pTransform->Load_Data(root["Transform"]);
}

void CEffect_LobbyCampFireSmoke::Update_Network(const string& pkey) {
}

void CEffect_LobbyCampFireSmoke::Update_Network(void) {
}
