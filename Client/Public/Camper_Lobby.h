...
private:
	ECamper m_eCamper = ECamper::DWIGHT;
	_bool m_bRender = true;

	_float m_fDissolveLength = 0.f;
	_float m_fGoalDissolveLength = -0.1f;
	_float m_fDissolveLength1 = 0.f;
	_float m_fGoalDissolveLength1 = -0.1f;
	_float m_fDissolveLength2 = 0.f;
	_float m_fGoalDissolveLength2 = -0.1f;
	_float m_fDissolveLength3 = 0.f;
	_float m_fGoalDissolveLength3 = -0.1f;
