...
class CEffect_LogoParticle final : public CUI {
	struct DirKeyFrame {
		_float	fDirTime = 0.f;
...
public:
	static CEffect_LogoParticle* const Create(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork, const _tchar* const& pFilePath = nullptr);
	virtual CObject* const Clone(void* const& pArg = nullptr) override;
private:
	explicit CEffect_LogoParticle(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork);
	explicit CEffect_LogoParticle(const CEffect_LogoParticle& rhs);
	virtual ~CEffect_LogoParticle(void) override = default;
