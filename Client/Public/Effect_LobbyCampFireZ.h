...
class CEffect_LobbyCampFireZ final : public CObject{
	struct DirKeyFrame {
		_float	fDirTime = 0.f;
...
public:
	static CEffect_LobbyCampFireZ* const Create(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork, const _tchar* const& pFilePath = nullptr);
	virtual CObject* const Clone(void* const& pArg = nullptr) override;
private:
	explicit CEffect_LobbyCampFireZ(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork);
	explicit CEffect_LobbyCampFireZ(const CEffect_LobbyCampFireZ& rhs);
	virtual ~CEffect_LobbyCampFireZ(void) override = default;
