...
class CEffect_BloodStain final : public CObject {
	struct EffectModel {
...
public:
	static CEffect_BloodStain* const Create(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork, const _tchar* const& pFilePath = nullptr);
	virtual CObject* const Clone(void* const& pArg = nullptr) override;
private:
	explicit CEffect_BloodStain(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork);
	explicit CEffect_BloodStain(const CEffect_BloodStain& rhs);
	virtual ~CEffect_BloodStain(void) override = default;
...
private:
	...
	_float3 m_fRight = { 0.f,0.f,0.f };
	_float3 m_fUp = { 0.f,0.f,0.f };
	_float3 m_fLook = { 0.f,0.f,0.f };
