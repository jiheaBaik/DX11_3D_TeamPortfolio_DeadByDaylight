...
class CFS_Slasher_Attack_Slash_In final : public CFS {
public:
	explicit CFS_Slasher_Attack_Slash_In(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork, class CSlasher_Huntress* const& pSlasher_Huntress);
	virtual ~CFS_Slasher_Attack_Slash_In(void) override = default;
