...
class CFS_Camper_Closet_Hide final : public CFS {
public:
	explicit CFS_Camper_Closet_Hide(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork, class CCamper_GamePlay* const& pCamper_GamePlay);
	virtual ~CFS_Camper_Closet_Hide(void) override = default;
