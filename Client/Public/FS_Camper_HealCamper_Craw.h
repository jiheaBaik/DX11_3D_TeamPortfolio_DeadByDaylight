...
class CFS_Camper_HealCamper_Craw final : public CFS {
public:
	explicit CFS_Camper_HealCamper_Craw(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork, class CCamper_GamePlay* const& pCamper_GamePlay);
	virtual ~CFS_Camper_HealCamper_Craw(void) override = default;
