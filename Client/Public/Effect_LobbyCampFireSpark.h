...
class CEffect_LobbyCampFireSpark final : public CObject {
	struct DirKeyFrame {
		_float	fDirTime = 0.f;
...
public:
	static CEffect_LobbyCampFireSpark* const Create(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork, const _tchar* const& pFilePath = nullptr);
	virtual CObject* const Clone(void* const& pArg = nullptr) override;
private:
	explicit CEffect_LobbyCampFireSpark(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork);
	explicit CEffect_LobbyCampFireSpark(const CEffect_LobbyCampFireSpark& rhs);
	virtual ~CEffect_LobbyCampFireSpark(void) override = default;
