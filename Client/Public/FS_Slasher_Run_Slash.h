...
class CFS_Slasher_Run_Slash final : public CFS {
public:
	enum ERun { RUN_FT, RUN_BK, RUN_RT, RUN_LT, RUN_FTRT, RUN_FTLT, RUN_BKRT, RUN_BKLT, END };
public:
	explicit CFS_Slasher_Run_Slash(ID3D11Device* const& pDevice, ID3D11DeviceContext* const& pContext, class CNetwork* const& pNetwork, class CSlasher_Huntress* const& pSlasher_Huntress);
	virtual ~CFS_Slasher_Run_Slash(void) override = default;
